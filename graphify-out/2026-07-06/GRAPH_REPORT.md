...
## Corpus Check
- 166 files · ~137,042 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1413 nodes · 1978 edges · 132 communities (65 shown, 67 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 22 edges (avg confidence: 0.89)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `906dd49e`
...
3. `PsychologistsComponent` - 34 edges
4. `FacultiesComponent` - 31 edges
5. `ConsultaComponent` - 30 edges
6. `AgendaComponent` - 29 edges
...
Cohesion: 0.09
Nodes (7): EmergencyModalData, AuditService, AuthService, EmergencyChangeRequest, WebPushSubscriptionPayload, WhatsAppRoutingSession, CalendarDay
...
Cohesion: 0.17
Nodes (9): environment, CampoFormulario, Psychologist, Holiday, HealthProfessionalItem, HealthProfessionalRegistrationPayload, PatientAssignmentPayload, ChartDataPoint (+1 more)
...
Cohesion: 0.18
Nodes (5): AgendaService, TimeBlock, WorkingDay, CalendarDay, CalendarDay
...
- **Why does `SupabaseService` connect `Community 68` to `Community 0`, `Community 67`, `Main App Security Interceptors`, `Community 78`, `Dashboard Main Navigation Layout`, `Community 84`, `Community 87`, `Community 88`, `Community 59`?**
  _High betweenness centrality (0.059) - this node is a cross-community bridge._
- **Why does `AuthService` connect `Dashboard Main Navigation Layout` to `Community 0`, `Community 67`, `Community 68`, `Community 78`, `Main App Security Interceptors`, `Community 84`, `Community 87`, `Community 59`?**
