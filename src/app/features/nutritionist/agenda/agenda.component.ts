...
export class Agenda implements OnInit {
  ...
  async performSearch() {
    ...
    this.isLoading = true;
    // Buscar en appointments usando el ID del nutricionista
    ...
    this.selectedDate = null; // Mostrar vista de resultados en lugar de la agenda diaria
    this.isLoading = false;
  }
  ...
  buildTimeline() {
    ...
    this.dayBlocks.forEach(b => {
      this.timelineItems.push({
        time: b.start,
        type: 'block',
        title: 'Horario Base Nutricional',
