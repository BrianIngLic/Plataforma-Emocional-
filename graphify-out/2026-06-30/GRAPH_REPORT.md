...
3. `RiskLevel` - 33 edges
4. `TriageEngine` - 30 edges
5. `AgendaComponent` - 29 edges
6. `UserMessage` - 28 edges
...
Cohesion: 0.07
Nodes (27): dependencies, @angular/animations, @angular/cdk, @angular/common, @angular/compiler, @angular/core, @angular/forms, @angular/material (+19 more)
